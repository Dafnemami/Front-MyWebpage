...
var $ = (e) => {
  if (S.has(e))
    return;
  let t = setTimeout(() => {
    S.delete(e), u2({ type: 4, toastId: e });
  }, X);
  S.set(e, t);
};
var J = (e) => {
...
var G = (e, t = "blank", o) => ({ createdAt: Date.now(), visible: true, type: t, ariaProps: { role: "status", "aria-live": "polite" }, message: e, pauseDuration: 0, ...o, id: (o == null ? void 0 : o.id) || U() });
var h2 = (e) => (t, o) => {
  let s = G(t, e, o);
  return u2({ type: 2, toast: s }), s.id;
};
var n = (e, t) => h2("blank")(e, t);
n.error = h2("error");
...
n.remove = (e) => u2({ type: 4, toastId: e });
n.promise = (e, t, o) => {
...
var D = (e) => {
  ...
  let s = (0, import_react2.useCallback)(() => {
    o && u2({ type: 6, time: Date.now() });
  }, [o]), a = (0, import_react2.useCallback)((r, c) => {
...
var M = ({ toast: e }) => {
  ...
  return t !== void 0 ? typeof t == "string" ? y.createElement(fe, null, t) : t : o === "blank" ? null : y.createElement(le, null, y.createElement(V, { ...s }), o !== "loading" && y.createElement(ue, null, o === "error" ? y.createElement(_, { ...s }) : y.createElement(w, { ...s })));
};
var ye = (e) => `
...
var Ae = (e, t) => {
  ...
  return { animation: t ? `${h(a)} 0.35s cubic-bezier(.21,1.02,.73,1) forwards` : `${h(r)} 0.4s forwards cubic-bezier(.06,.71,.55,1)` };
};
var F = l.memo(({ toast: e, position: t, style: o, children: s }) => {
  let a = e.height ? Ae(e.position || t || "top-center", e.visible) : { opacity: 0 }, r = l.createElement(M, { toast: e }), c = l.createElement(Se, { ...e.ariaProps }, T(e.message, e));
  return l.createElement(be, { className: e.className, style: { ...a, ...o, ...e.style } }, typeof s == "function" ? s({ icon: r, message: c }) : l.createElement(l.Fragment, null, r, c));
});
m(f.createElement);
var Ee = ({ id: e, className: t, style: o, onHeightUpdate: s, children: a }) => {
  ...
  return f.createElement("div", { ref: r, className: t, style: o }, a);
};
var Re = (e, t) => {
...
`;
var O = 16;
var Ie = ({ reverseOrder: e, position: t = "top-center", toastOptions: o, gutter: s, children: a, containerStyle: r, containerClassName: c }) => {
  let { toasts: i, handlers: d } = D(o);
  return f.createElement("div", { style: { position: "fixed", zIndex: 9999, top: O, left: O, right: O, bottom: O, pointerEvents: "none", ...r }, className: c, onMouseEnter: d.startPause, onMouseLeave: d.endPause }, i.map((p) => {
    let g = p.position || t, E = d.calculateOffset(p, { reverseOrder: e, gutter: s, defaultPosition: t }), x = Re(g, E);
    return f.createElement(Ee, { id: p.id, key: p.id, onHeightUpdate: d.updateHeight, className: p.visible ? ve : "", style: x }, p.type === "custom" ? T(p.message, p) : a ? a(p) : f.createElement(F, { toast: p, position: g }));
  }));
};
var _t = n;
export {
